...
Require-Exact $manifest 'package_version' '0.5.0' 'manifest.ini'
Require-Exact $manifest 'library_version' '0.5.0' 'manifest.ini'
Require-Exact $manifest 'api_version' '2.0.0' 'manifest.ini'
...
Require-Exact $version 'package_version' '0.5.0' 'VERSION'
Require-Exact $version 'library_version' '0.5.0' 'VERSION'
Require-Exact $version 'api_version' '2.0.0' 'VERSION'
